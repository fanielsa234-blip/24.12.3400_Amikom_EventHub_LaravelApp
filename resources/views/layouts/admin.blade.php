...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    <aside class="w-64 bg-indigo-900 text-indigo-100 flex flex-col p-6 space-y-8 sticky top-0 h-screen">
       ...
       <nav class="flex-1 space-y-2">
            ...
            <a href="/admin/partners" class="flex items-center gap-3 px-4 py-3 {{ Request::is('admin/partners*') ? 'bg-indigo-800 text-white' : 'hover:bg-indigo-800 text-indigo-300 hover:text-white' }} rounded-xl font-bold transition">
